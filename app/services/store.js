...
const products = [
  Product.create({title: 'Tent', price: 10, description: 'Sleeps 2', imageUrl: ''}),
  Product.create({title: 'Sleeping Bag', price: 5, description: 'Good to 30 degrees F', imageUrl: ''}),
  Product.create({title: 'Flashlight', price: 2, description: 'Light up your life', imageUrl: ''}),
  Product.create({title: 'First-aid Kit', price: 3, description: 'Stay not dead', imageUrl: ''})
];
